    ...
    <table class="showAllTable">
        ...
        <%
            ...
            for (Course course : courses) {
                out.print("<tr><td>" + course.getId() + "</td><td>" + course.getName() + "</td>");
                String formHtml = "<form action=\"" + request.getContextPath() +
                        "/courseServlets/PreEditCourseServlet\" method=\"post\">" +
                ...
                formHtml = "<form action=\"" + request.getContextPath() +
                        "/courseServlets/DeleteCourseServlet\" method=\"post\">" +
                        "<input type=\"hidden\" name=\"id\" value=" + course.getId() + ">";
                formHtml += "<input type=\"submit\" value=\"Delete\" onclick=\"return " +
                        "confirm('Do you really want to delete this Course?')\" class=\"smallButton\"></form>";
                out.print("<td>" + formHtml + "</td>");
            }
        %>
    </table>
    <form action="<%=request.getContextPath()%>/course/create.jsp">
        <input type="submit" value="Add new Course" class="smallButton"/>
    </form>
